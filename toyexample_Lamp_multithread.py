    ...
    for stackid, (actinfile, dnafile, GFPfile) in enumerate(zip(actinfiles, dnafiles, GFPfiles)):
        ...
        try:
                ...
                for index, row in obj_df.iterrows():
                    ...
                    if biological_conditions_satisfied:  # and datautils.checkfinitetemp(cellattribute_testvals[1:8]):
                        ...
                        if no_members > 0:
                            ...
                            cellstackaspectratio2d[t, w, 0, r % 5, fovno, obj_index] = Cmaxferet / Cminferet
                            # meta.createcelldict()
                            ...
                            for memberdna_no in range(no_members):
                                ...
                                if memberdna_no >= 2:
                                    ...
                                    dnavol1 = dnastackvols[t, w, 0, r % 5, fovno, obj_index, 0]
                                    dnavol2 = dnastackvols[t, w, 0, r % 5, fovno, obj_index, 1]
                                ...
                                dnastackyspan[t, w, 0, r % 5, fovno, obj_index, usememberdnaid] = Dyspan
                                dnastackzspan[t, w, 0, r % 5, fovno, obj_index, usememberdnaid] = Dzspan
                                dnastackmiparea[t, w, 0, r % 5, fovno, obj_index, usememberdnaid] = Dmiparea
                                dnastacksphericity[t, w, 0, r % 5, fovno, obj_index, usememberdnaid] = Dsphericity
                                dnastackmaxferet[t, w, 0, r % 5, fovno, obj_index, usememberdnaid] = Dmaxferet
                                dnastackminferet[t, w, 0, r % 5, fovno, obj_index, usememberdnaid] = Dminferet
            ...
            for it, iw, ir, ifovno, obj_id, cvol, process in processes:
                ...
                gfpstackmaxferet[it, iw, 0, ir % 5, ifovno, obj_id, :] = Gmaxferet
                gfpstackminferet[it, iw, 0, ir % 5, ifovno, obj_id, :] = Gminferet
                gfpstackaspectratio2d[it, iw, 0, ir % 5, ifovno, obj_id, :] = Gmaxferet / Gminferet
